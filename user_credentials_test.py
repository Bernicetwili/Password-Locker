...
class TestUser(unittest.TestCase):
	...
	def test__init__(self):
		...
		'''
		self.assertEqual(self.new_user.first_name,'Bernice')
		self.assertEqual(self.new_user.last_name,'Twili')
...
class TestCredentials(unittest.TestCase):
	...
	def setUp(self):
		...
		'''
		self.new_credential = Credential('Bernice','Instagram','bernicetwili','1234')

	def test__init__(self):
		'''
		Test to if check the initialization/creation of credential instances is properly done
		'''
		self.assertEqual(self.new_credential.user_name,'Bernice')
		self.assertEqual(self.new_credential.site_name,'Instagram')
		self.assertEqual(self.new_credential.account_name,'bernicetwili')
	...
	def test_copy_credential(self):
		...
		'''
		self.new_credential.save_credentials()
		twitter = Credential('Mirriam','Twitter','beernicetwili','1234')
		twitter.save_credentials()
